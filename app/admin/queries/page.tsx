...
import { HelpCircle, Clock, CheckCircle, Send, User, MessageSquare, Loader2, Mail } from 'lucide-react'
                    ...
                    {selectedQuery.status === 'answered' ? (
                      ...
                      <>
                        ...
                        <div className="flex gap-3">
                          <Button className="flex-1" onClick={handleSendReply} disabled={!replyText.trim() || sending}>
                            {sending ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : <Send className="mr-2 h-4 w-4" />}Send Reply
                          </Button>
                          <Button variant="outline" onClick={() => { setSelectedQuery(null); setReplyText('') }}>Cancel</Button>
                        </div>
                      </>
                    )}
                  </div>
